...
$( document).ready(function() {
    ...
    // for(var i = 0; i < dairy.length; i++){
        $("#dairy-dropdown-section > div > div").append('<input class="form-check-input" type="checkbox" value="" id="dairyEntry' + 1 + '"><label id="dairy' + 1 + '" class="form-check-label" for="dairyEntry' + 1 + '"></label><br>');
        $("#dairy" + 1).text(dairy[1]);
    // }
