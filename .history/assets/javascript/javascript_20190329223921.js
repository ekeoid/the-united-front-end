...
$( document).ready(function() {
    ...
    for(var i = 0; i < beverages.length; i++){
        $("#beverages-dropdown-section > div > div").append('<input class="form-check-input" type="checkbox" value="" id="dairyEntry1"><label id="beverages" class="form-check-label" for="dairyEntry1"></label><br>');
