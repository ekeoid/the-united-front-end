...
$( document).ready(function() {
    ...
    // for(var i = 0; i < dairy.length; i++){
        $("#dairy-dropdown-section > div > div").append('<input class="form-check-input" type="checkbox" value="" id="dairyEntry' + i + '"><label id="dairy' + i + '" class="form-check-label" for="dairyEntry' + 1 + '"></label><br>');
